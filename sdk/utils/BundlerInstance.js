...
class BundlerInstance {
    static async connect(rpcurl, bundlerUrl, entryPointAddress, factoryAddress, eoa, index = 0) {
        ...
        const erc4337Provider = await wrapProvider(provider, config, eoa, factoryAddress)
