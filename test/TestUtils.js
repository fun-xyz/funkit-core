...
const HARDHAT_FORK_CHAIN_NAME = "ethereum-localfork"
...
module.exports = {
    ...
    HARDHAT_FORK_CHAIN_ID, HARDHAT_FORK_CHAIN_NAME, RPC_URL, PRIV_KEY, PKEY, DAI_ADDR, TEST_API_KEY, USDC_ADDR, AVAX_CHAIN_ID, AVAX_RPC_URL, USDC_AVAX_ADDR, AVAX_RECEIVE_PKEY
}
